...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--total-steps', type=int, default=96 * 100 * 100)
    parser.add_argument('--steps-per-epoch', type=int, default=96 * 100)
    parser.add_argument('--batch-size', type=int, default=80 * 20)
